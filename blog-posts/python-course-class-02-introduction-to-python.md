---
title: "What Is Python? A Complete Beginner Guide"
...
2. [History, Versions, and Evolution](#history-versions-and-evolution)
3. [Why Learn Python?](#why-learn-python)
4. [Applications and Use Cases](#applications-and-use-cases)
5. [Popular Frameworks and Libraries](#popular-frameworks-and-libraries)
6. [Running Python Code and Understanding Its Execution](#running-python-code-and-understanding-its-execution)
...
This class builds directly on [Class 01: Orientation and Setup](https://smartgentools.com/blog/python-course-class-01-orientation-and-setup/) — if you haven't already got Python installed on your computer, that's the place to start before running the code examples below.
...
4. Type a line of code directly and press Enter to see it run immediately:
...
5. Type `exit()` and press Enter to leave the shell.
...
3. Save the file.
4. Open your terminal, navigate to the folder containing `hello.py`, and run:

```
python3 hello.py
```

5. Type your name when prompted, and press Enter to see your personalized greeting printed back.
