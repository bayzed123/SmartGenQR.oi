...
Usage:
    python pagespeed.py https://smartgentools.com
    python pagespeed.py https://smartgentools.com --strategy mobile
    python pagespeed.py https://smartgentools.com --json
    PAGESPEED_API_KEY=AIza... python pagespeed.py https://smartgentools.com
"""
